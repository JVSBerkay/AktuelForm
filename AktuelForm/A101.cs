...
{
    public partial class A101 : Form
    {
        ...
        private void A101_Load(object sender, EventArgs e)
        {
            ...
            string query1 = "SELECT Urun_Gorseli FROM a101_urun WHERE a101_urun_id =1";
            ...
            string query2 = "SELECT Urun_fiyati FROM a101_urun WHERE a101_urun_id =1";
            ...
            string query3 = "SELECT Urun_adi FROM a101_urun WHERE a101_urun_id =2";
            ...
            string query4 = "SELECT Urun_Gorseli FROM a101_urun WHERE a101_urun_id =2";
            ...
            string query5 = "SELECT Urun_fiyati FROM a101_urun WHERE a101_urun_id =2";
            ...
            string query6 = "SELECT Urun_adi FROM a101_urun WHERE a101_urun_id =3";
            ...
            string query7 = "SELECT Urun_Gorseli FROM a101_urun WHERE a101_urun_id =3";
            ...
            string query8 = "SELECT Urun_fiyati FROM a101_urun WHERE a101_urun_id =3";
            ...
            string query9 = "SELECT Urun_adi FROM a101_urun WHERE a101_urun_id =3";
